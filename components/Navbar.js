...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="bg-gray-900 text-white flex flex-col md:flex-row justify-between items-center px-4 h-22 md:h-16">
            <Link href={"/"}><div className="flex items-center logo text-lg font-bold">

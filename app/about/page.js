...
const About = () => {
    return (
        <div className="text-white container mx-auto px-8 md:px-4 py-8">
            <h1 className="flex justify-center text-3xl font-semibold mb-4">About Get Me a Chai</h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/assets/group.gif" alt="Fans Want to Collaborate" />
                    <div>
                ...
                <div className="flex items-center mb-6">
                    <img className="w-20 h-20 rounded-full mr-4" src="/assets/coin.gif" alt="Support Through Chai" />
                    <div>
